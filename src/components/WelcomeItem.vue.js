...
/** @type {__VLS_StyleScopedClasses['item']} */ ;
/** @type {__VLS_StyleScopedClasses['item']} */ ;
__VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "item" }));
/** @type {__VLS_StyleScopedClasses['item']} */ ;
__VLS_asFunctionalElement(__VLS_intrinsics.i, __VLS_intrinsics.i)({});
var __VLS_0 = {};
__VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "details" }));
